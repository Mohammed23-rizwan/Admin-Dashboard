      ...
      <div className="pt-[10px] px-[9px]">
        <div className="w-[100%] h-[205px] rounded-[10px] bg-[#EDEDED] relative">
          ...
          <div className="flex flex-col justify-center items-center h-full">
            <div className="w-[65px] h-[65px] border border-[#414040] rounded-full"></div>
            <h2 className="text-[14px] pt-1">Mohammed Rizwan S</h2>
            <p className="text-[11px]">@mohammed-23Rizwan</p>
